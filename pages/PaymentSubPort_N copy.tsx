...
export const PaymentSubPort_N = (props:any) => {
    ...
    //         // 업그레이드시 필요한 옵션들!
    //         prorationModeAndroid : ProrationModesAndroid.IMMEDIATE_AND_CHARGE_PRORATED_PRICE,  //2번
    //         purchaseToken : activeSubscriptionTokenAndroid,
    //         oldSku: productId, // 기존 구독
            

    //         subscriptionUpdateParams: {
    //             oldSku: productId, // 기존 구독
    //             purchaseToken: activeSubscriptionTokenAndroid, // 기존 구독의 purchaseToken
    //             prorationMode: ProrationModesAndroid.IMMEDIATE_AND_CHARGE_PRORATED_PRICE, // 업그레이드 시 즉시 전체 가격을 청구
                
    //             oldSkuAndroid: productId, // 기존 구독
    ...
    async function buySubscription() {
        ...
        const param = activeSubscriptionTokenAndroid === ''?params:paramUpDownGrade;
        console.log(param);
