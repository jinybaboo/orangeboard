...
const MyAccountGroupEdit_W = (props:any) => {
    const {from} = props.route.params.param;

    const [isLoading, setIsLoading] = useState(true);
    const navigation:any = useNavigation();
    const webViewRef:any = useRef(null);
    const webviewUrl = `${BASE_URL}/myAccount/groupEdit?isApp=app&from=${from}`;
...
export default MyAccountGroupEdit_W;