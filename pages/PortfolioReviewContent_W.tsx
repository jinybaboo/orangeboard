...
const PortfolioReviewContent_W = (props:any) => {
    const {from, idx} = props.route.params.param;

    const [isLoading, setIsLoading] = useState(true);
    const navigation:any = useNavigation();
    const webViewRef:any = useRef(null);
    const webviewUrl = `${BASE_URL}/portfolio/reviewContent?isApp=app&from=${from}&idx=${idx}`;
...
export default PortfolioReviewContent_W;