...
const StudyAccount_W = (props:any) => {
    const {studyPath, PortAccId} = props.route.params.param;
    
    const [isLoading, setIsLoading] = useState(true);
    const navigation:any = useNavigation();
    const webViewRef:any = useRef(null);
    const webviewUrl = `${BASE_URL}/study/studyAccount?isApp=app&studyPath=${studyPath}&PortAccId=${PortAccId}`;
