...
const AnalysisMyRequestDetail_W = (props:any) => {
    const {AnalysisReqId} = props.route.params.param;
    const [isLoading, setIsLoading] = useState(true);
    const navigation:any = useNavigation();
    const webViewRef:any = useRef(null);
    const webviewUrl = `${BASE_URL}/analysis/myRequestDetail?isApp=app&AnalysisReqId=${AnalysisReqId}`;
...
export default AnalysisMyRequestDetail_W;