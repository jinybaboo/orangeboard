...
const StudyContentReply_W = (props:any) => {
    const {studyPath, StudyPostId} = props.route.params.param;
    const [isLoading, setIsLoading] = useState(true);
    const navigation:any = useNavigation();
    const webViewRef:any = useRef(null);
    const webviewUrl = `${BASE_URL}/report/reply?isApp=app&studyPath=${studyPath}&StudyPostId=${StudyPostId}&from=studyContent`;
...
export default StudyContentReply_W;