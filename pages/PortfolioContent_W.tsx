...
const PortfolioContent_W = (props:any) => {
    const {pageName, PortfolioId} = props.route.params.param;

    const [isLoading, setIsLoading] = useState(true);
    const navigation:any = useNavigation();
    const webViewRef:any = useRef(null);
    const webviewUrl = `${BASE_URL}/portfolio/content?isApp=app&pageName=${pageName}&PortfolioId=${PortfolioId}`;
...
export default PortfolioContent_W;