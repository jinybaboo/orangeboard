...
const EtcIntroFarmerGuideContent_W = (props:any) => {
    const {GuidePostId} = props.route.params.param;

    const [isLoading, setIsLoading] = useState(true);
    const navigation:any = useNavigation();
    const webViewRef:any = useRef(null);
    const webviewUrl = `${BASE_URL}/etc/introFarmerGuideContent?isApp=app&GuidePostId=${GuidePostId}`;
...
export default EtcIntroFarmerGuideContent_W;