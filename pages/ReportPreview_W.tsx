...
const ReportPreview_W = (props:any) => {
    const {ReportId} = props.route.params.param;
    
    const [isLoading, setIsLoading] = useState(true);
    const navigation:any = useNavigation();
    const webViewRef:any = useRef(null);
    const webviewUrl = `${BASE_URL}/report/preview?isApp=app&r=${ReportId}`;
...
export default ReportPreview_W;