...
const MypageNotice_W = (props:any) => {
    const {type} = props.route.params.param;
    
    const [isLoading, setIsLoading] = useState(true);
    const navigation:any = useNavigation();
    const webViewRef:any = useRef(null);
    const webviewUrl = `${BASE_URL}/mypage/notice?isApp=app&type=${type}`;
