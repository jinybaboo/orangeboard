...
const AnalysisRequest_W = (props:any) => {
    const {pageName, corpName, stockCode} = props.route.params.param;

    const [isLoading, setIsLoading] = useState(true);
    const navigation:any = useNavigation();
    const webViewRef:any = useRef(null);
    const webviewUrl = `${BASE_URL}/analysis/request?isApp=app&pageName=${pageName}&corpName=${corpName}&stockCode=${stockCode}`;
...
export default AnalysisRequest_W;