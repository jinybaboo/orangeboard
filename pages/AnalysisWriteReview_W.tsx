...
const AnalysisWriteReview_W = (props:any) => {
    const {AnalysisReqId} = props.route.params.param;
    const [isLoading, setIsLoading] = useState(true);
    const navigation:any = useNavigation();
    const webViewRef:any = useRef(null);
    const webviewUrl = `${BASE_URL}/analysis/writeReview?isApp=app&AnalysisReqId=${AnalysisReqId}`;
...
export default AnalysisWriteReview_W;