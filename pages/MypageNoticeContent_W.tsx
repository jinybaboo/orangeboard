...
const MypageNoticeContent_W = (props:any) => {
    const {type, id} = props.route.params.param;

    const [isLoading, setIsLoading] = useState(true);
    const navigation:any = useNavigation();
    const webViewRef:any = useRef(null);
    const webviewUrl = `${BASE_URL}/mypage/noticeContent?isApp=app&type=${type}&id=${id}`;
...
export default MypageNoticeContent_W;