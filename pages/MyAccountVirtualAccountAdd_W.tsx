...
const MyAccountVirtualAccountAdd_W = (props:any) => {
    const [isLoading, setIsLoading] = useState(true);
    const navigation:any = useNavigation();
    const webViewRef:any = useRef(null);
    const webviewUrl = `${BASE_URL}/myAccount/virtualAccountAdd?isApp=app`;
...
export default MyAccountVirtualAccountAdd_W;