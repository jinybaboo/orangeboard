...
const StudyMain_W = (props:any) => {
    const {studyPath} = props.route.params.param;
    
    const [isLoading, setIsLoading] = useState(true);
    const navigation:any = useNavigation();
    const webViewRef:any = useRef(null);
    const webviewUrl = `${BASE_URL}/study/studyMain?isApp=app&studyPath=${studyPath}`;
    ...
    useEffect(() => {
        DeviceEventEmitter.addListener('backFromStudyContentWrite', () => {
